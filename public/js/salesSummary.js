...
function setSalesSummaryTable(data) {
  ...
  $.each(data, function(key, obj) {
    ...
    $.each(obj, function(k, o) {
      var categoryName = o.categoryName.length > 15 ? insertStr(o.categoryName, 15, '\n') : o.categoryName;
      trStr.push('<tr>');
      if(idx == 0) {
        trStr.push('<td rowspan="' + obj.length + '" class="dptd" style="width:240px;vertical-align:middle;text-align:center;border:1px solid black;">' + categoryName + '</td>');
        trStr.push('<td rowspan="' + obj.length + '" class="dptd" style="width:400px;font-size:13px;vertical-align:middle;border:1px solid black;">' + o.itemName + '</td>');
      }
