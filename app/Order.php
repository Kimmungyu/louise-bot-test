...
class Order extends Model
{
  ...
  */
  ...
  protected $fillable = [
    ...
    'creditcard_type_id', 'creditcard_amount', 'eccard_amount', 'cash_amount', 'cash_received', 'voucher_amount', 'voucher_code', 'delievery_cost', 'is_voucher_sales',
    'member_id', 'kasse_id', 'cashier_id', 'created_at', 'updated_at'
  ];
