...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <h2 class="support-header">Print Barcode</h2>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
      <table id="checkprice-table" class="table table-bordered table-product-list-result" style="table-layout: fixed;"> <!-- table-bordered table-condensed table-hover -->
        <thead>
          <tr>
      ...
      <div class="text-center" id="table-paginator"></div>
      <div><br></div>
    </div>
  </div>
</div>
