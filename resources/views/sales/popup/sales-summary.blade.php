  ...
  <div class="col-md-12">
    ...
    <div class="block">
      <table class="table dptbl-sm mt30">
        <thead>
          <tr>
            <th width="240px" style="text-align:center;border:1px solid black;">Category</th>
            <th width="401px" style="border:1px solid black;">Item Name</th>
            <th width="70px" style="text-align:center;border:1px solid black;">D/C</th>
            <th width="70px" style="text-align:center;border:1px solid black;">Qty</th>
            <th width="112px" style="text-align:center;border:1px solid black;">Amount</th>
          </tr>
        </thead>
